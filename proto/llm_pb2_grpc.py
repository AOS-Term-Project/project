...
class LLMServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetLLMAnswer = channel.unary_unary(
                ...
                request_serializer=llm__pb2.GetLLMAnswerRequest.SerializeToString,
                response_deserializer=llm__pb2.GetLLMAnswerResponse.FromString,
...
def add_LLMServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetLLMAnswer': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=llm__pb2.GetLLMAnswerRequest.FromString,
                    response_serializer=llm__pb2.GetLLMAnswerResponse.SerializeToString,
            ),
    }
...
class LLMService(object):
    ...
    def GetLLMAnswer(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/llm.LLMService/GetLLMAnswer',
            llm__pb2.GetLLMAnswerRequest.SerializeToString,
            llm__pb2.GetLLMAnswerResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
